...
Pod::Spec.new do |s|
  ...
  s.homepage     		= "https://github.com/XiaoFuGenius/XiaoFuTech-develop" 	# 你的主页
  s.source       		= { :git => "https://github.com/XiaoFuGenius/XiaoFuTech-develop.git", :tag => "#{s.version}" } 	# 你的仓库地址
